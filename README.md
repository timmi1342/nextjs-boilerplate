...
Страница целиком статическая: ни форм, ни обращений к серверу. Книга
пожеланий, форма подтверждения участия и галерея фотографий были удалены
вместе с их бэкендом на Neon Postgres — если что-то из этого понадобится
снова, история git хранит и разметку, и обработчики.
...
| обратный отсчёт | JS, цель `2026-10-17T18:00:00+05:00` |
